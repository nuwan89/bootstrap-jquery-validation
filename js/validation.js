...
$V.load = function(custom){$.extend(true,$V.settings,custom);};
    //Handles validation
    $(function(){
        /**
            Following section will create OO clases
        */
        ...
        */
        function setupDynamic(){
            $(".form-horizontal .form-group").find("input[type=text].form-control")
        ...
        function init(){
            ...
            $("form").each(function(){
                if($(this).data("validate")){
                    $(this).submit(function(event){return validate($(this));});
                }
            });
            /**
            ...
            */
            $(".form-horizontal .form-group").find("input[type=text].form-control")
            .after("<span class='error-field-text alert-danger'>ERROR TEXT</span>").next()
            ...
            */
            ...
            function validate(form){
                ...
                */
                ...
                $(form).find(".form-group input[type=text].form-control")
                .each(function(){
                    var isValidate = $(this).data("validate");
                    if(isValidate){
                        console.log("VALIDATING!");
